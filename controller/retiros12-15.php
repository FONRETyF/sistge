<?php
    ...
    session_start();
    require_once "/var/www/html/sistge/model/Retiros12-15.php";
    $retiro = new Retiros();
    ...
    switch ($_GET["op"]) {
        ...
        case 'deleteTramiteHist':
            $a_deleteTramHist = $retiro->deleteTramHist($_POST["identret"],$_POST["cvemae"],$_SESSION['usuario']);
            echo json_encode($a_deleteTramHist);
            break;
