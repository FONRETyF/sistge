<?php
    ...
    if ($motivoRet == "FRF") {     
        ...
        $pdf->Ln(1.5);
        $pdf->Cell(18.59, 0.5, utf8_decode('ACUERDO DE FONDO DE RETIRO POR   '.$motivoRetiro), 0, 0, 'C');
        ...
        if ($resultsM[0]['numpsgs'] == 0) {
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',2.8,8.4,12.7,0.04);
            $pdf->Ln(1.5);
            $pdf->SetFont('Arial','',12);
            ...
            $pdf->Ln(0.5);
            $pdf->SetFont('Arial','B',11);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',1.5,8.9,3.3,0.04);
            ...
            $pdf->Ln(0.5);
            $pdf->SetFont('Arial','B',11);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',1.5,9.4,10.59,0.04);
            ...
            $pdf->Ln(0.5);
            $pdf->SetFont('Arial','',12);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',5.8,9.9,2.8,0.04);
            ...
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',10.4,9.9,5.2,0.04);
            $pdf->SetFont('Arial','B',11);
            ...
            $pdf->SetFont('Arial','B',11);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',3.05,10.4,1.0,0.04);
            ...
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',10.2,10.4,2.8,0.04);
            $pdf->SetFont('Arial','B',11);
            $pdf->Cell(2.8, 0.5,date("d-m-Y",strtotime($resultsT[0]['fechbajfall'])) , 0, 0, 'C');
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(3.79, 0.5,", periodo durante el", 0, 0, 'l');
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',13.5,10.4,2.8,0.04);

            $pdf->Ln(0.5);
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(1.8, 0.5,"cual tuvo", 0, 0, 'L');
            $pdf->SetFont('Arial','B',11);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',3.3,10.9,1.1,0.04);
            ...
            $pdf->SetFont('Arial','B',11);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',17.3,10.9,1.1,0.04);
            $pdf->Cell(1.09, 0.5,$resultsM[0]['aservactmae'], 0, 0, 'C');
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(1.7,0.5,utf8_decode("años  de"),0, 0, 'L');

            $pdf->Ln(0.5);            
            $pdf->Cell(14.1, 0.5,utf8_decode("servicio cotizados al SMSEM, con fundamento en los artículos 30, 33, 34, 35, 36, 37, 38, 41, 43  y"), 0, 0, 'L');

            $pdf->Ln(0.5);
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(17.6, 0.5, utf8_decode("44 del Reglamento del Fondo de Retiro y Fallecimiento (FONRETyF)."), 0, 0, 'L');
        ...
        /*   ACUERDO POR FALLECIMEINTO ACTIVO CON PSGS   */
            ...
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',2.7,8.4,10.7,0.04);
            $pdf->Ln(1.5);
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(1.2, 0.5, "Yo C.", 0, 0, 'L');
            $pdf->SetFont('Arial','B',11);
            ...
            $pdf->Ln(0.5);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',7.5,8.9,10.6,0.04);
            ...
            $pdf->Ln(0.5);
            $pdf->SetFont('Arial','',12);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',14.55,9.4,3.2,0.04);
            ...
            $pdf->Ln(0.5);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',1.5,9.9,5.2,0.04);
            $pdf->SetFont('Arial','B',11);
            $pdf->Cell(5.3, 0.5,$resultsM[0]['curpmae'], 0, 0, 'C');
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(6,0.5, utf8_decode("y laboraba en la región sindical"), 0, 0, 'L');
            $pdf->SetFont('Arial','B',11);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',12.8,9.9,1.0,0.04);
            $pdf->Cell(1, 0.5,$resultsM[0]['regescmae'], 0, 0, 'C');
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(6.29, 0.5," como docente basificado (a)  del", 0, 0, 'L');
            
            $pdf->Ln(0.5);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',1.5,10.4,2.8,0.04);
            $pdf->SetFont('Arial','B',11);
            $pdf->Cell(2.8, 0.5,date("d-m-Y",strtotime($resultsM[0]['fcbasemae'])), 0, 0, 'C');
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(0.5, 0.5," al ", 0, 0, 'C');
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',4.8,10.4,2.8,0.04);
            $pdf->SetFont('Arial','B',11);
            $pdf->Cell(2.8, 0.5,date("d-m-Y",strtotime($resultsT[0]['fechbajfall'])) ,0, 0, 'C');
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(5.8, 0.5,", periodo  durante  el cual tuvo", 0, 0, 'L');
            $pdf->SetFont('Arial','B',11);
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',13.4,10.4,1,0.04);
            ...
            $pdf->Image('/var/www/html/sistge/img/lineafirma.png',8.5,13,1.1,0.04);
            $pdf->Cell(7,0.5,utf8_decode(", por lo que se realiza la solicitud por"),0, 0, 'L');
            $pdf->SetFont('Arial','B',11);
            $pdf->Cell(1.1, 0.5,$resultsM[0]['aservactmae'], 0, 0, 'C');
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(10.49, 0.5,utf8_decode("años de servicio cotizados al SMSEM, con fundamento"), 0, 0, 'L');

            $pdf->Ln(0.5);
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(18.59, 0.5, utf8_decode("en  los  artículos  30, 33, 34, 35, 36, 37, 38, 41, 43 y 44  del  Reglamento  del  Fondo  de  Retiro  y"), 0, 0, 'L');
            $pdf->Ln(0.5);
            $pdf->SetFont('Arial','',12);
            $pdf->Cell(18.59, 0.5, utf8_decode("Fallecimiento (FONRETyF)."), 0, 0, 'L');
            ...
            if (count($resultsB) < 7) {
                ...
                */
                ...
                $pdf->SetY(20);
                $pdf->SetFont('Arial','',12);
                $pdf->Cell(18.59, 0.5,"asi mismo,  ratifico  que  los datos  especificados  anteriormente  son  correctos  para  el  calculo y", 1,0, 'L');
                $pdf->Ln(0.5);
                $pdf->Cell(18.59, 0.5,"entrega del Fondo de Retiro, por lo cual firmo de conformidad al respecto.", 1,0, 'L');
