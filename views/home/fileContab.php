<?php
    ...
    $consultacheques = $consultacheques . " where tab1.identrega='".$identrega."' and (tab1.modretiro='C' or tab1.modretiro='D50') order by statedad asc, case when motvret='I' then 1 when motvret='J' then 2 when motvret='FA' then 3 when motvret='FJ' then 4 end asc, nomcommae asc, nombenef asc;";
