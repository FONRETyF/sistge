...
<section class="contenidoGral">        
    <form class="FormcontenidoGral" action="" method="POST" name="" id="form_captTramite" enctype="multipart/form-data">
        ...
        <section id="SecCapturaTram">
            ...
            <div id="causaRetiro">Programa Retiro: &nbsp
