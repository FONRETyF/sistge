...
accionActRetiro.addEventListener("click", function (event) {
    ...
    var montTotRet = document.getElementById('montRet').value;
...
function calculaRetiro() {
    ...
    if (document.getElementById('CheckAdeudos').checked && document.getElementById('montRetSinAded').value!=="") {
        montoRetiro = document.getElementById('montRetSinAded').value;
        if (modalidad == "C") {
            document.getElementById('monRetEntr').value = montoRetiro;
            document.getElementById("montRetFondFall").style.display = "none";
            document.getElementById("DivTpoDiferido").style.display = "none";
...
function agregaRetFallecimiento() {
    $.post("../../controller/tramites.php?op=agregarF",{Ianioentr:$("#AnioEntr").val(),
                                                        ...
                                                        ImontretSnAdeds:$("#montRetSinAded").val(),
                                                        ...
                                                        IAdedFajam:$("#AdedFajam").val(),
                                                        IAdedTS:$("#AdedTS").val(),
                                                        IAdedFondPension:$("#AdedFondPension").val(),
                                                        IAdedTurismo:$("#AdedTurismo").val(),
                                                        ...
                                                        ImontAdeudos: document.getElementById('montAdeudos').value
                                                        },function (data) {
