...
$(document).ready(function () {
    ...
    $('#retiros_data12').dataTable({
        ...
        "ajax":{
            url: '../../controller/retiros12-15.php?op=listar&identrega='+ identrega,
            type : "post",
            dataType : "json",
            error: function(e){
...
function obtenEstatEntr(identrega) {
    $.post("../../controller/retiros12-15.php?op=buscaEnt",{identrega:identrega},function(data){
...
function mostrar(identret,cvemae) {
    $.post("../../controller/retiros12-15.php?op=getTram",{identret:identret},function(data){
        ...
        if (motivoRet == "J" || motivoRet == "I" || motivoRet == "FA") {
            $.post("../../controller/retiros12-15.php?op=mostrarJI",{identret:identret,modretiro:modretiro,cvemae:cvemae,motivoRet:motivoRet},function(datos){
                ...
                if (motivoRet == "J" || motivoRet == "I") {
                    ...
                    $.post("../../controller/retiros12-15.php?op=busqbenefs",{cvemae:cvemae},function(data){
            ...
            $.post("../../controller/retiros12-15.php?op=mostrarFJ",{identret:identret,modretiro:modretiro,cvemae:cvemae,motivoRet:motivoRet},function (datos) {
                datos = JSON.parse(datos);
                motivo="FALLECIMIENTO";
                progamret = "COMPLETO";
...
function eliminarTH(identret,cvemae) {
    swal.fire({
        ...
        if (result.isConfirmed){
            $.post("../../controller/retiros12-15.php?op=deleteTramiteHist",{identret:identret,cvemae:cvemae},function(data){
                ...
                switch (NumregsResult) {
                    case 3:
                        if (resultadoDelete[0] == "Eliminado" && resultadoDelete[1] == "Actualizado" && resultadoDelete[2] == "Eliminado" ) {
                            tabla = $('#retiros_data12').DataTable();
                            tabla.ajax.reload();
                            swal.fire(
                                'Eliminado!',
