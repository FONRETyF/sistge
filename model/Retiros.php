    ...
    class Retiros extends formularioTram{
        ...
        public function get_retiros($identrega){
            ...
            if ($estatentr =="CERRADA") {
                ...
                $consulta = $consulta . " FROM public.tramites_fonretyf_hist as tab1, public.maestros_smsem as tab2 WHERE tab1.cvemae = tab2.csp UNION SELECT tab1.cvemae,tab2.nomcommae FROM public.tramites_fonretyf_hist as tab1, public.mutualidad as tab2 WHERE tab1.cvemae = tab2.cveissemym) as tab2 on tab1.cvemae= tab2.cvemae WHERE identrega='" . $identrega . "' and (motvret='I' or motvret='J' or motvret='FRI' or motvret='FRJ' or motvret='FRR' or motvret='FRD') ORDER BY identret DESC;";
                ...
                $consultaF = $consultaF . " SELECT tab1.cvemae,tab2.nomcommae FROM public.tramites_fonretyf_hist as tab1, public.mutualidad as tab2 WHERE tab1.cvemae = tab2.cveissemym) as tab2 on tab1.cvemae= tab2.cvemae WHERE identrega= '".$identrega."' and (motvret='FA' or motvret='FJ' or motvret='FRF' or motvret='FMJ' or motvret='FFJ') ORDER BY identret DESC;";
        ...
        public function deleteTram($identreret,$clavemae,$cveusu){
            ...
            if ($tramite[0]['motvret'] == "FRJ" || $tramite[0]['motvret'] == "FRI" || $tramite[0]['motvret'] == "FRR" || $tramite[0]['motvret'] == "FRD") {
                ...
                switch ($modoretiro) {
                    case 'C':
                        ...
                        if ($a_resultDeleteTram["eliminaCheque"] == "Eliminado" && $a_resultDeleteTram["actualizaMaestro"] == "Actualizado" && $a_resultDeleteTram["eliminaTramite"] == "Eliminado" ) {
                            ...
                            } elseif ($tramite[0]['motvret']=="FRR") {
                                try{
									$statementActEntr = "UPDATE public.entregas_fonretyf SET numtramites=". ($get_entrega[0][12] - 1) .", numtramren=". ($get_entrega[0][42] - 1) .", monttotentr=". str_replace(",","",str_replace("$","",$get_entrega[0][29])) - str_replace(",","",str_replace("$","",$tramite[0]['montrettot'])) ."  WHERE identrega='".substr($identreret,0,6)."'";                            
									$statementActEntr = $this->db->prepare($statementActEntr);
									$statementActEntr->execute();
									$resultsActEntr = $statementActEntr->fetchAll(PDO::FETCH_ASSOC);
									$a_resultDeleteTram["updateEntrega"] = "Actualizada";
                            ...
                            } elseif ($tramite[0]['motvret']=="FRD") {
                                try{
									$statementActEntr = "UPDATE public.entregas_fonretyf SET numtramites=". ($get_entrega[0][12] - 1) .", numtramresc=". ($get_entrega[0][43] - 1) .", monttotentr=". str_replace(",","",str_replace("$","",$get_entrega[0][29])) - str_replace(",","",str_replace("$","",$tramite[0]['montrettot'])) ."  WHERE identrega='".substr($identreret,0,6)."'";                            
									$statementActEntr = $this->db->prepare($statementActEntr);
									$statementActEntr->execute();
									$resultsActEntr = $statementActEntr->fetchAll(PDO::FETCH_ASSOC);
									$a_resultDeleteTram["updateEntrega"] = "Actualizada";
        ...
        public function updateFolsCheques($identrega,$numfolini){
            ...
            $consultacheques = $consultacheques . " public.mutualidad as tab2 WHERE tab1.cvemae = tab2.cveissemym) as tab3 on tab1.cvemae= tab3.cvemae WHERE tab1.identrega='".$identrega."' and tab1.motvret='FRI' and (tab1.modretiro='C' or tab1.modretiro='D50') and tab2.statedad = 'M' and tab2.chequeadeudo = 'N' and tiptramne='0' ORDER  BY nomcommae ASC;";
            ...
            $consultacheques = "SELECT tab1.identret,tab1.cvemae,tab1.motvret,tab1.modretiro,tab2.idbenefcheque,tab2.nombenef,tab2.montbenef,tab2.montbenefletra,tab2.statedad,tab2.chequeadeudo,tab2.adeudo,tab3.nomcommae FROM public.tramites_fonretyf as tab1 LEFT JOIN public.beneficiarios_cheques as tab2 on tab1.identret = tab2.identret";
            $consultacheques = $consultacheques . " LEFT JOIN (SELECT tab1.cvemae,tab2.nomcommae,tab2.fcbasemae,tab2.fbajamae FROM public.tramites_fonretyf as tab1, public.maestros_smsem as tab2 WHERE tab1.cvemae = tab2.csp UNION SELECT tab1.cvemae,tab2.nomcommae,tab2.fechbajamae,tab2.fcfallecmae FROM public.tramites_fonretyf as tab1,";
            $consultacheques = $consultacheques . " public.mutualidad as tab2 WHERE tab1.cvemae = tab2.cveissemym) as tab3 on tab1.cvemae= tab3.cvemae WHERE tab1.identrega='".$identrega."' and tab1.motvret='FRJ' and (tab1.modretiro='C' or tab1.modretiro='D50') and tab2.statedad = 'M' and tab2.chequeadeudo = 'N' and tiptramne='0' ORDER  BY nomcommae ASC;";
            ...
            $consultachequesF = $consultachequesF . " public.mutualidad as tab2 WHERE tab1.cvemae = tab2.cveissemym) as tab3 on tab1.cvemae= tab3.cvemae WHERE tab1.identrega='".$identrega."' and (tab1.motvret='FRF' or tab1.motvret='FMJ') and (tab1.modretiro='C' or tab1.modretiro='D50') and tiptramne='0' ORDER  BY nomcommae ASC;";
